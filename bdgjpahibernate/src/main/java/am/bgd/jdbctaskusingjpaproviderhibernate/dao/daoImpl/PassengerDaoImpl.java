package am.bgd.jdbctaskusingjpaproviderhibernate.dao.daoImpl;

import am.bgd.jdbctaskusingjpaproviderhibernate.dao.PassengerDao;
import am.bgd.jdbctaskusingjpaproviderhibernate.entity.Passenger;
...
public class PassengerDaoImpl implements PassengerDao {
    ...
    public Passenger fetchById(long id) throws SQLException {
        ...
        Passenger passenger = entityManager.find(am.bgd.jdbctaskusingjpaproviderhibernate.entity.Passenger.class, id);
